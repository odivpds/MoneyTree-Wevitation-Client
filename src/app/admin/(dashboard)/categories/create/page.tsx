  ...
  return (
    <div className="space-y-8 max-w-3xl">
      <div>
        ...
        <h2 className="text-4xl font-serif tracking-tight text-[#222] mt-4 mb-2">Tambah Kategori Baru</h2>
        <p className="text-gray-500 text-sm">Buat kategori baru untuk mengelompokkan template undangan Anda.</p>
      </div>

      <form action={createCategory} className="bg-white rounded-3xl border border-[#E6DFD1] p-8 space-y-6 shadow-sm">
