...
export default function HomeClient({ initialCategories }: HomeClientProps) {
  ...
  const sortedCategories = useMemo(() => {
    return [...initialCategories].sort((a: any, b: any) => {
    ...
    <>
      ...
      <section className="section" id="fitur">
        <div className="container text-center">
          ...
          <div className="features-grid reveal-stagger" style={{ marginTop: 'var(--space-12)' }}>
      ...
      {/* ===== TEMPLATE SHOWCASE ===== */}
      <section className="section bali-border-top" id="desain">
        <div className="container text-center">
      ...
      {/* ===== PRICING ===== */}
      <section className="section bali-pattern-bg" id="harga">
        <div className="container text-center">
      ...
      {/* ===== TESTIMONIALS ===== */}
      <section className="section bali-border-top" id="testimoni">
        <div className="container text-center">
      ...
      {/* ===== CTA SECTION ===== */}
      <section className="section text-center bali-corners" style={{ position: 'relative', overflow: 'hidden', paddingTop: '10rem' }}>
